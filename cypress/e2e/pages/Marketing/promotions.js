class Promotions{
    elements = {
        ...
        // add promotion page
        addPhoto: () => cy.get('#full-width-tabpanel-0 > .MuiBox-root > .MuiTypography-root > .mb-14 > div.col-span-3 > .flex > .Gallery > .add-block'),
        ...
        descriptionEN: () => cy.get('#full-width-tab-1 > .MuiTab-wrapper > .flex > .px-1').click().get('#description_en'),
        // uz
