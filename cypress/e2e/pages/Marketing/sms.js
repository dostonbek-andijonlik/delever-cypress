class SMS{
    elements = {
        ...
        search: () => cy.get(':nth-child(1) > .focus-within\\:ring-2 > .bg-white > .flex > .flex-1'),
        ...
        firstSelectBoxClient: () => cy.get('.MuiTableBody-root > .MuiTableRow-root > :nth-child(1)').find('input'),
        firstSelectBoxCourier: () => cy.get('#full-width-tabpanel-1 > .MuiBox-root > .MuiTypography-root > [style="border-top: 1px solid rgb(238, 238, 238); padding-top: 10px;"] > .MuiTableContainer-root > .MuiTable-root > .MuiTableBody-root > .MuiTableRow-root > :nth-child(1)').find('input'),
        
        //clientPeriod
        periodField: () => cy.get('.gap-4 > .space-x-2'),
        fromDayField: () => cy.get('.rc-calendar-range-left > [style="outline: none;"] > .rc-calendar-header > div > .rc-calendar-my-select > .rc-calendar-month-select'),
        ...
        toDayField: () => cy.get('.rc-calendar-range-right > [style="outline: none;"] > .rc-calendar-body'),
