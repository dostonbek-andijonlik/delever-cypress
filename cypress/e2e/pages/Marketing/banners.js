class Banners {
  elements = {
    ...
    actions: () =>
      cy.get(
        ":nth-child(1) > :nth-child(6) > .flex > .ActionMenu > .MuiButtonBase-root > .MuiButton-label > .MuiSvgIcon-root"
      ),
    ...
    nameRU: () =>
      cy.get(
        "#full-width-tabpanel-0 > .MuiBox-root > .MuiTypography-root > .grid > .col-span-9 > :nth-child(1) > .mr-4 > .Input > input"
      ),
    nameEN: () =>
      cy
        ...
        .click()
        .get(
          "#full-width-tabpanel-2 > .MuiBox-root > .MuiTypography-root > .grid > .col-span-9 > :nth-child(1) > .mr-4 > .Input > input"
        ),
    addPhoto: () =>
      cy.get(
        "#full-width-tabpanel-2 > .MuiBox-root > .MuiTypography-root > .grid > .col-span-3 > :nth-child(1) > .Gallery > .mt-2"
      ),
    link: () =>
      cy.get(
        "#full-width-tabpanel-2 > .MuiBox-root > .MuiTypography-root > .grid > .col-span-9 > :nth-child(2) > .mr-4 > .Input > input"
      ),
    status: () =>
      cy.get(
        "#full-width-tabpanel-2 > .MuiBox-root > .MuiTypography-root > .grid > .col-span-9 > :nth-child(3) > .w-full > .w-3/4 > #active"
      ),
