class Popups {
  elements = {
    ...
    actions: () =>
      cy.get(
        ":nth-child(1) > :nth-child(6) > .flex > .ActionMenu > .MuiButtonBase-root > .MuiButton-label"
      ),
    ...
    popupPeriod: () =>
      cy.get(
        "#full-width-tabpanel-0 > .MuiBox-root > .MuiTypography-root > .grid > .col-span-10 > :nth-child(3) > .mr-4"
      ), // ru
    dayOne: () => cy.get(".rc-calendar-selected-end-date > .rc-calendar-date"),
    dayTwo: () => cy.get('[title="6 января 2023 г."] > .rc-calendar-date'),
    fromTime: () =>
      cy.get(
        "#full-width-tabpanel-0 > .MuiBox-root > .MuiTypography-root > .grid > .col-span-10 > :nth-child(3) > .ml-4"
      ),
    toTime: () =>
      cy.get(
        "#full-width-tabpanel-0 > .MuiBox-root > .MuiTypography-root > .grid > .col-span-10 > :nth-child(3) > :nth-child(3)"
      ),
    link: () =>
      cy.get(
    ...
    status: () =>
      cy.get(
        "#full-width-tabpanel-0 > .MuiBox-root > .MuiTypography-root > .grid > .col-span-10 > :nth-child(6) > .w-1/3 > .w-3/4"
      ),
    priority: () =>
      cy.get(
        "#full-width-tabpanel-2 > .MuiBox-root > .MuiTypography-root > .grid > .col-span-10 > :nth-child(6) > :nth-child(2)"
      ),
    addPhoto: () =>
      cy.get(
