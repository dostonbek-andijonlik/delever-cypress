class Apelsin{
    elements = {
        apelsinPage: () => cy.get(':nth-child(2) > .spanITem > .undefined > .w-full > :nth-child(1)').click().get('.flex-col > :nth-child(5) > a > .sidebarItem'),
        ...
        // add apelsin
        addApelsinCredential: () => cy.get('.button'),
        chooseBranch: () => cy.get('.css-1wa3eu0-placeholder'),
        cashID: cy.get('.focus-within\:ring-2 > .bg-white > .flex > .flex-1'),
        saveButton: () => cy.get(':nth-child(2) > .button'),
        cancelButton: () => cy.get(':nth-child(1) > .button'),
    }   
}

module.exports = new Apelsin()
