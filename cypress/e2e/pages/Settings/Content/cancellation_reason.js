class CancellationReason{
    elements = {
        cancellationPage: () => cy.get(':nth-child(6) > .spanITem > .undefined > .w-full > .-rotate-180 > .MuiSvgIcon-root').click().get(':nth-child(6) > .spanITem > .undefined > .flex-col > :nth-child(2) > a > .sidebarItem > span'),
        search: cy.get(':nth-child(6) > .spanITem > .undefined > .flex-col > :nth-child(1) > a > .sidebarItem'),
        addButton: cy.get(':nth-child(6) > .spanITem > .undefined > .flex-col > :nth-child(1) > a > .sidebarItem'),
...
module.exports = new CancellationReason()