class Couriers{
    elements = {
        ...
        searchCourier: () => cy.get('.focus-within\\:ring-2 > .bg-white > .flex'),
    ...
    searchCourier(courierName){
        this.elements.searchCourier().type(courierName)
        this.elements.firstTableItem().should('contain', courierName)
        this.elements.searchCourier().clear()
    };
    ...
    editCourier(
        ...
        this.elements.maxOrderCountField().click().clear().type(newMaxOrderQuantity)
        this.elements.saveButton().click()
