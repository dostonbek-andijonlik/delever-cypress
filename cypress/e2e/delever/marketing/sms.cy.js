...
describe("SMS", () => {
  ...
  it("Send SMS to CLient", () => {
    cy.wait(1000);
    SMS.sendToClient("Test Cypress Message", "I am TESTER");
  });

  it("Filter Clients by order price", () => {
    cy.wait(1000);
    SMS.clientOrderPriceFilter("12", "140000");
  });

  it("Filter Clients by order quantity ", () => {
    cy.wait(1000);
    SMS.clientOrderQuantityFilter("10", "200");
  });

  it("Choose Client Period", () => {
    cy.wait(1000);
    SMS.clientDatePicker("13 января 2023 г.", "25 февраля 2023 г.");
  });
