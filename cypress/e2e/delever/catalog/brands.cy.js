...
const imagesPath =
  "C:/Users/ASUS/cypress/cypress/e2e/delever-cypress/cypress/fixtures/logo.jpg";
...
describe("Brands", () => {
  ...
  it("Search Brand", () => {
    cy.wait(1000);
    getBrands.searchBrand("test");
  });

  it("Add Brand", () => {
    cy.wait(1000);
    getBrands.addBrand("Cypress Amigo", "1", imagesPath);
  });

  it("Edit Brand", () => {
    cy.wait(1000);
    getBrands.editBrand("Cypress Amigo", "Amigo Edited", "2", imagesPath);
  });
